    ...
    <section class="main">
        <div class="mainContainer">
            ...
            <div class="col-sm-4 item">
                ...
                <h1>Eet plekskes</h1>
                <div class="block_img">
                    <img src="{{ asset('images/ontdek/eet_plekskes.jpg') }}" alt="eet plekskes">
                    <div class="block_">
                        <p>
                    ...
                    <div class="btn-section_">
                        <a href="{{ route('discover_eat_places') }}" class="btn-custom"> + meer lezen </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4  item">
                <div class="rondje">
                    ...
                    <img src="{{ 'images/M-icon.png' }}" alt="icon" class="iconL">
                </div>
                <h1>Studie plekskes</h1>
                <div class="block_img">
                    <img src="{{ asset('images/ontdek/studie_plekskes.jpg') }}" alt="studie plekskes">
                    <p class="columnText">
                    ...
                    <div class="btn-section_">
                        <a href="{{ route('discover_study_places') }}" class="btn-custom"> + meer lezen </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 item">
                <div class="rondje">
                    ...
                    <img src="{{ asset('images/R-icon.png') }}" alt="icon" class="iconL">
                </div>
                <h1>Toffe plekskes</h1>
                <div class="block_img">
                    <img src="{{ asset('images/ontdek/schoon_plekskes.jpg') }}" alt="schoon plekskes">
                    <p class="columnText">
                    ...
                    <div class="btn-section_">
                        <a href="{{ route('discover_fun_places') }}" class="btn-custom"> + meer lezen </a>
                    </div>
                </div>
            </div>
        </div>
